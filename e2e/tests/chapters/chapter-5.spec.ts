 ...
 * Chapter 5 E2E tests.
 *
 * Chapter 5 requires authentication and chapters 1-4 to be completed.
 * Tests use auth.skipToChapter(5) to skip directly to chapter 5.
 *
 * Chapter 5 is about "Will the Real Satoshi Please Stand Up" - digital signatures.
