 ...
 * Chapter 3 E2E tests.
 *
 * Chapter 3 requires authentication and chapters 1-2 to be completed.
 * Tests use auth.setupForChapter(3) to skip directly to chapter 3.
 *
 * Chapter 3 is about the "51% Attack" and teaches about mining pools.
