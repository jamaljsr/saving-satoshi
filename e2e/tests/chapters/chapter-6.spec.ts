 ...
 * Chapter 6 E2E tests.
 *
 * Chapter 6 requires authentication and chapters 1-5 to be completed.
 * Tests use auth.skipToChapter(6) to skip directly to chapter 6.
 *
 * Chapter 6 is about building and signing a SegWit transaction.
 * It has two tracks: normal (3 put-it-together lessons) and hard (6 put-it-together lessons).
 *
...
test.describe('Chapter 6: Building SegWit Transactions', () => {
  ...
  test('complete chapter 6 - hard', async ({
    ...
    test.setTimeout(60_000) // 1 minute - more scripting challenges in hard mode
